...
env.read_env(env.str("ENV_PATH", os.path.join(BASE_DIR, "dev.env")))
...
# SECRET_KEY = "zpxq6e$-a^h6$+ex-@7(vc8=qa#3*2u6_eng@)$2+@0mbcv1fm"
...
#     "5a824725c9bd45ef92e402d580741815.vfs.cloud9.us-east-1.amazonaws.com",
# ]
