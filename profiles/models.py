...
class Profile(models.Model):
    ...
    ethnicity = models.CharField(
        choices=ETHNICITY, default="WHITE", blank=False, max_length=100
    )
    ...
    looking_for = models.CharField(
        choices=LOOKING_FOR, default="BOTH", blank=False, max_length=6
    )
    ...
    is_verified = models.CharField(
        choices=APPROVAL, default="TO BE APPROVED", blank=False, max_length=14
    )
